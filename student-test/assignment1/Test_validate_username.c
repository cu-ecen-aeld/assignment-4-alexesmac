...
void test_validate_my_username()
{
     ...
     */
    const char * hardcodedVal;
    const char * fromFile;
    hardcodedVal = my_username();
    fromFile = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE( hardcodedVal, fromFile, "alexesmac");
}
